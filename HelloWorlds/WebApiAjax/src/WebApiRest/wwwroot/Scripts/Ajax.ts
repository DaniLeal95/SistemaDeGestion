...
function post() {
    ...
    personaSeleccionada.setPersona(newWindowPost.document.getElementById("nombre").value,
        newWindowPost.document.getElementById("apellido").value,
        newWindowPost.document.getElementById("fechaNac").value,
        newWindowPost.document.getElementById("direccion").value,
        newWindowPost.document.getElementById("telefono").value);
